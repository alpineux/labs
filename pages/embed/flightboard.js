...
import { Table, Badge, Avatar } from 'evergreen-ui'
...
export default function FlightBoard() {
	...
	return(
	    <body style={{ height: '100%', width: '100%', margin: 0 }}>
	    	<div style={{ width: '100vw', height: '100%', minHeight: '100vh', boxSizing: 'border-box', overflowX: 'hidden', overflowY: 'hidden' }}>
		    	{!loading ?
	            	<div>
	            		<Table>
						  <Table.Head>
...

	            		{
	                		flights.departures.map((flight, index) => {
	                			...
	                			return(
	                				<Table.Row key={flight.number} isSelectable onSelect={() => alert(flight.name)}>
								        <Table.TextCell>
								        	<Avatar
